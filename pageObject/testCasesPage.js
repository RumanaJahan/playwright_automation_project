...
//--------------------------------------------------------------------------------------------------------------------------
////Function to launch the testcase page
//--------------------------------------------------------------------------------------------------------------------------
...
{ 
    ...
    console.log('Test Cases page launched successfully when clicking the button');
}
...
{ 
    ...
    //Log a message to the console indicating successful navigation
    console.log('Test Cases page launched successfully when clicking the menu');
}